...
public class JFrm_Datos_Cliente extends javax.swing.JPanel {
 ...
 void cargar_Datos(){
    ...
    void Cargar_Fila()
    {
        ...
        this.TXT_Direccion.setText(this.jTable_DatosCliente.getValueAt(Seleccion,10).toString());
        this.TXT_Telefono.setText(this.jTable_DatosCliente.getValueAt(Seleccion,11).toString());
        this.TXT_Email.setText(this.jTable_DatosCliente.getValueAt(Seleccion,12).toString());
        this.BTN_Registrado.setText(this.jTable_DatosCliente.getValueAt(Seleccion,13).toString());
    ...
    void Leer_Datos()
    {
        ...
        String Codigo,Apellidos,Nombres,FechaNacimiento,Sexo,Nacionalidad,TipoDocIdentidad,DocIdentidad
    ...
    private void initComponents() {
        ...
        TXT_DocIdentidad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TXT_DocIdentidadActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(CBO_Pronvincia, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(BTN_Desactivado, javax.swing.GroupLayout.PREFERRED_SIZE, 985, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void TXT_DocIdentidadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TXT_DocIdentidadActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TXT_DocIdentidadActionPerformed
    ...
    private void TXT_DocIdentidadKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXT_DocIdentidadKeyTyped
        ...
        }else if(CBO_TipoDoc.getSelectedIndex()==1){
